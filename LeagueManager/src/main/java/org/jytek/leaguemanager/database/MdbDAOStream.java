 ...
 * @param <V>
 */
public abstract class MdbDAOStream<K, V extends KeyValue<K, V>> {
    /**
     *
     */
    ...
    MdbDAOStream(final Database db, final String name) throws IOException {
        this.name = name;
    ...
    public boolean has(final K key) {
        return daoHashMap.containsKey(key);
    }
